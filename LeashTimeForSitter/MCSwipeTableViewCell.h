...
@property (nonatomic,strong,readwrite) UILabel *petName;
@property (nonatomic,strong,readwrite) UILabel *serviceName;
@property (nonatomic,strong,readwrite) UILabel *starttime;
@property (nonatomic,strong,readwrite) UILabel *endtime;
@property (nonatomic,strong,readwrite) UILabel *addressVisit;
@property (nonatomic,strong,readwrite) UILabel *keyID;

@property (nonatomic,strong,readwrite) UIImageView *petPic;
@property (nonatomic,strong,readwrite) UIImageView *keyPic;
@property (nonatomic,strong,readwrite) UIImageView *medicalPic;
@property (nonatomic,strong,readwrite) UIImageView *lockPic;
@property (nonatomic,strong,readwrite) UIImageView *notePic;
@property (nonatomic,strong,readwrite) UIImageView *backIm;


@property (nonatomic,strong,readwrite) UILabel *latLonLabel;
@property (nonatomic,strong,readwrite) UILabel *latLonLabel2;
@property (nonatomic,strong,readwrite) UILabel *numberCoord;
