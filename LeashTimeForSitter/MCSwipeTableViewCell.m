...
static CGFloat const kMCStop1                       = 1.0; // Percentage limit to trigger the first action
static CGFloat const kMCStop2                       = 1.0; // Percentage limit to trigger the second action
static CGFloat const kMCBounceAmplitude             = 1.0; // Maximum bounce amplitude when using the MCSwipeTableViewCellModeSwitch mode
static CGFloat const kMCDamping                     = 0.0;  // Damping of the spring animation
static CGFloat const kMCVelocity                    = 0.1;  // Velocity of the spring animation
static CGFloat const kMCAnimationDuration           = 2.9;  // Duration of the animation
static NSTimeInterval const kMCBounceDuration1      = 1.5;  // Duration of the first part of the bounce animation
static NSTimeInterval const kMCBounceDuration2      = 1.5;  // Duration of the second part of the bounce animation
static NSTimeInterval const kMCDurationLowLimit     = 1.0; // Lowest duration when swiping the cell because we try to simulate velocity
static NSTimeInterval const kMCDurationHighLimit    = 2.0;  // Highest duration when swiping the cell because we try to simulate velocity
...
- (void)uninstallCellData {
    [_backIm removeFromSuperview];
    [_petName removeFromSuperview];
    [_mainLabel removeFromSuperview];
    [_starttime removeFromSuperview];
    [_endtime removeFromSuperview];
    [_keyID removeFromSuperview];
    [_petPic removeFromSuperview];
