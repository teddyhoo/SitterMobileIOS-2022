...
//  LeashTimeForSitter
//
//  Created by Edward Hooban on 9/21/17.
...
- (instancetype)initWithMessage:(NSString *)message
	...
	if (self = [super initWithFrame:CGRectMake(0, 0, 0, 0)]) {
		...
		//NSLog(@"Phone type: %@",[[VisitsAndTracking sharedInstance] tellDeviceType]);
		...
		_messageLabel.font = [UIFont fontWithName:@"Lato-Regular" size:fontSize];
...
- (NSArray *)visibleVerticalLayoutConstraints {
	if (!_visibleVerticalLayoutConstraints) {
		...
		if(_messageLabel.text.length > 230) {
			

			_visibleVerticalLayoutConstraints =
			[NSLayoutConstraint constraintsWithVisualFormat:@"V:[self(366)]-(5)-|"
													options:0
													metrics:nil
													  views:NSDictionaryOfVariableBindings(self)];	
			
			_messageLabel.numberOfLines = 24;
			_messageLabel.font = [UIFont fontWithName:@"Lato-Regular" size:fontSize];
			
		} else if(_messageLabel.text.length > 150  && _messageLabel.text.length < 230) {
			
			_visibleVerticalLayoutConstraints =
			[NSLayoutConstraint constraintsWithVisualFormat:@"V:[self(222)]-(5)-|"
													options:0
													metrics:nil
													  views:NSDictionaryOfVariableBindings(self)];
			
			_messageLabel.font = [UIFont fontWithName:@"Lato-Regular" size:fontSize];
			_messageLabel.numberOfLines = 14;

			
		} else if(_messageLabel.text.length < 151) {
			
			_visibleVerticalLayoutConstraints =
			[NSLayoutConstraint constraintsWithVisualFormat:@"V:[self(122)]-(5)-|"
													options:0
													metrics:nil
													  views:NSDictionaryOfVariableBindings(self)];
...
/*	 [NSLayoutConstraint constraintsWithVisualFormat:@"|-8-[_messageLabel]-(>=8)-[_separator(1)]-8-[_actionButton]-8-|"
	...
	*/
	...
	[NSLayoutConstraint constraintsWithVisualFormat:@"|-8-[_messageLabel]-(>=8)-[_separator(1)]-8-[_actionButton(>=30@50)]-8-|"
											options:NSLayoutFormatAlignAllCenterY
											metrics:nil
											  views:NSDictionaryOfVariableBindings(_messageLabel, _actionButton, _separator)]];
